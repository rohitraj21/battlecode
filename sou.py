...
class Planet(enum.IntEnum):
    ...
    def from_json(s):
        ...
        :rtype: Planet
        '''
        result = _lib.bc_Planet_from_json(_ffi.new("char[]", s))
        _check_errors()
        result = Planet(result)
        return result
...
class Direction(enum.IntEnum):
    ...
    def from_json(s):
        ...
        :rtype: Direction
        '''
        result = _lib.bc_Direction_from_json(_ffi.new("char[]", s))
        _check_errors()
        result = Direction(result)
        return result
...
class MapLocation(object):
    ...
    def from_json(s):
        ...
        :rtype: MapLocation
        '''
        result = _lib.bc_MapLocation_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = MapLocation.__new__(MapLocation)
        if result != _ffi.NULL:
            _result._ptr = result
...
class Location(object):
    ...
    def from_json(s):
        ...
        :rtype: Location
        '''
        result = _lib.bc_Location_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = Location.__new__(Location)
        if result != _ffi.NULL:
            _result._ptr = result
...
class Team(enum.IntEnum):
    ...
    def from_json(s):
        ...
        :rtype: Team
        '''
        result = _lib.bc_Team_from_json(_ffi.new("char[]", s))
        _check_errors()
        result = Team(result)
        return result
...
class Player(object):
    ...
    def from_json(s):
        ...
        :rtype: Player
        '''
        result = _lib.bc_Player_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = Player.__new__(Player)
        if result != _ffi.NULL:
            _result._ptr = result
...
class UnitType(enum.IntEnum):
    ...
    def from_json(s):
        ...
        :rtype: UnitType
        '''
        result = _lib.bc_UnitType_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class Unit(object):
    ...
    def from_json(s):
        ...
        :rtype: Unit
        '''
        result = _lib.bc_Unit_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = Unit.__new__(Unit)
        if result != _ffi.NULL:
            _result._ptr = result
...
class PlanetMap(object):
    ...
    def from_json(s):
        ...
        :rtype: PlanetMap
        '''
        result = _lib.bc_PlanetMap_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = PlanetMap.__new__(PlanetMap)
        if result != _ffi.NULL:
            _result._ptr = result
...
class Delta(object):
    ...
    def from_json(s):
        ...
        :rtype: Delta
        '''
        result = _lib.bc_Delta_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class StartGameMessage(object):
    ...
    def from_json(s):
        ...
        :rtype: StartGameMessage
        '''
        result = _lib.bc_StartGameMessage_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class TurnMessage(object):
    ...
    def from_json(s):
        ...
        :rtype: TurnMessage
        '''
        result = _lib.bc_TurnMessage_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class StartTurnMessage(object):
    ...
    def from_json(s):
        ...
        :rtype: StartTurnMessage
        '''
        result = _lib.bc_StartTurnMessage_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class ViewerMessage(object):
    ...
    def from_json(s):
        ...
        :rtype: ViewerMessage
        '''
        result = _lib.bc_ViewerMessage_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class ViewerKeyframe(object):
    ...
    def from_json(s):
        ...
        :rtype: ViewerKeyframe
        '''
        result = _lib.bc_ViewerKeyframe_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class ErrorMessage(object):
    ...
    def error(self, error):
        ...
        :rtype: None
        '''
        result = _lib.bc_ErrorMessage_error_set(self._ptr, _ffi.new("char[]", error))
        _check_errors()
        return result
    ...
    def from_json(s):
        ...
        :rtype: ErrorMessage
        '''
        result = _lib.bc_ErrorMessage_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class AsteroidStrike(object):
    ...
    def from_json(s):
        ...
        :rtype: AsteroidStrike
        '''
        result = _lib.bc_AsteroidStrike_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = AsteroidStrike.__new__(AsteroidStrike)
        if result != _ffi.NULL:
            _result._ptr = result
...
class AsteroidPattern(object):
    ...
    def from_json(s):
        ...
        :rtype: AsteroidPattern
        '''
        result = _lib.bc_AsteroidPattern_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = AsteroidPattern.__new__(AsteroidPattern)
        if result != _ffi.NULL:
            _result._ptr = result
...
class OrbitPattern(object):
    ...
    def from_json(s):
        ...
        :rtype: OrbitPattern
        '''
        result = _lib.bc_OrbitPattern_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class GameMap(object):
    ...
    def from_json(s):
        ...
        :rtype: GameMap
        '''
        result = _lib.bc_GameMap_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = GameMap.__new__(GameMap)
        if result != _ffi.NULL:
            _result._ptr = result
...
class ResearchInfo(object):
    ...
    def from_json(s):
        ...
        :rtype: ResearchInfo
        '''
        result = _lib.bc_ResearchInfo_from_json(_ffi.new("char[]", s))
        _check_errors()
...
class RocketLanding(object):
    ...
    def from_json(s):
        ...
        :rtype: RocketLanding
        '''
        result = _lib.bc_RocketLanding_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = RocketLanding.__new__(RocketLanding)
        if result != _ffi.NULL:
            _result._ptr = result
...
class RocketLandingInfo(object):
    ...
    def from_json(s):
        ...
        :rtype: RocketLandingInfo
        '''
        result = _lib.bc_RocketLandingInfo_from_json(_ffi.new("char[]", s))
        _check_errors()
        _result = RocketLandingInfo.__new__(RocketLandingInfo)
        if result != _ffi.NULL:
            _result._ptr = result
